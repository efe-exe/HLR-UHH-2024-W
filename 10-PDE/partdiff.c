...
main (int argc, char** argv)
{
	...
	printf("[%d] (start_r=%ld, end_r=%ld, N_r=%ld, world_size=%d, N=%ld)", parameters.world_rank, parameters.start_r, parameters.end_r, parameters.N_r, parameters.world_size, arguments.N);
